...
export type SlimAsset = {
  ...
  visibility: "internal" | "public"; link: string | null; ext: string | null; pages: number | null; inventoried: boolean;
};
...
export type ChatAsset = { title: string; asset_type: string; industry: string; why: string; link: string | null; visibility: string; year: string | null; stale: boolean; path: string | null };
